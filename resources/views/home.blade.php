        ...
        <div class="col-lg-12">
            <div class="view-header">
                ...
                <div class="header-title">
                    <h3 class="m-b-xs">{{config('app.name')}} Dashboard</h3>
                    <small>
                        Welcome to dashboard. Arrange everything on one screen and view all as screen shot
                    </small>
                </div>
            </div>
            <hr>
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-xs-6">
            <div class="panel panel-filled">
                ...
                <div class="panel-body">
                    <h2 class="m-b-none">
                        206 <span class="slight"><i
                                    class="fa fa-play fa-rotate-270 text-warning"> </i> +20%</span>
                    </h2>
                    <div class="small">% New Sessions</div>
                    <div class="slight m-t-sm"><i class="fa fa-clock-o"> </i> Updated: <span class="c-white">10:22pm</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <div class="panel panel-filled">
                <div class="panel-body">
                    ...
                    <div class="slight m-t-sm"><i class="fa fa-clock-o"> </i> Updated: <span class="c-white">9:10am</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <div class="panel panel-filled">
                <div class="panel-body">
                    <h2 class="m-b-none">
                        262 <span class="slight"><i
                                    class="fa fa-play fa-rotate-270 text-warning"> </i> +56%</span>
                    </h2>
                    <div class="small">Total users</div>
                    <div class="slight m-t-sm"><i class="fa fa-clock-o"> </i> Updated: <span class="c-white">05:42pm</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <div class="panel panel-filled">
                <div class="panel-body">
                    <h2 class="m-b-none">
                        62% <span class="slight"><i
                                    class="fa fa-play fa-rotate-270 text-warning"> </i> +18%</span>
                    </h2>
                    <div class="small">Bounce Rate</div>
                    <div class="slight m-t-sm"><i class="fa fa-clock-o"> </i> Updated: <span class="c-white">04:00am</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                    <div class="m-t-sm">
                        <div class="pull-right">
                            <a href="index.html#" class="btn btn-default btn-xs">See locations</a>
                        </div>
                        <div class="c-white"><span class="label label-accent">+45</span> New visitor</div>
                        <span class="small c-white">120,312 <i
                                    class="fa fa-play fa-rotate-270 text-warning"> </i> -22%</span>
                        <!--<span class="sparkline"></span>-->
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="small">
                        <span class="c-white">Total users</span> from the beginning of activity. See detailed
                        charts for more information locations and traffic source.
                    </div>
                    <div class="m-t-sm">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="panel-body h-200 list">
                            ...
                            <div class="m-t-xl">
                                <small>
                                    More than 30% percent of users come from direct links. Check details page
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>Vosselaar</td>
                                <td><a href="index.html#" class="btn btn-default btn-xs">View</a></td>
                            </tr>
                            <tr>
                                <td>Phelan</td>
                                <td>0500 034548</td>
                                ...
                                <td>Lavoir</td>
                                <td><a href="index.html#" class="btn btn-default btn-xs active">View</a></td>
                            </tr>
                            <tr>
                                <td>Raya</td>
                                <td>(01315) 27698</td>
...
@section('extra-js')
    <script>
        $(document).ready(function () {
            ...
            {{--"timeOut": "6000"--}}
            {{--};--}}
            {{--toastr.warning('<strong>You entered to {{config('app.name')}}</strong> <br/><small>Premium admin theme with Dark UI style. </small>');--}}
            {{--}, 1600)--}}
